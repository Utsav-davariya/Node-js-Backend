...
userSchema.pre("save", async function (next) { // use normal function becuse of this. is not access in arrow () => {}
...
userSchema.methods.isPasswordCorrect = async function (password) {       //pre
